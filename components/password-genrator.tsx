...
import background from '../public/images/password-background.png'
...
export default function GeneratePassword() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
        <div className="w-full h-32 object-cover object-center">
        <Image
        src={background}
      ...
      <Card className="w-full max-w-md p-6 bg-emerald-400 dark:bg-gray-800 shadow-lg rounded-lg">
